...
-- -----------------------------------------------------
-- Schema ConLink_db_v03
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema ConLink_db_v03
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ConLink_db_v03` DEFAULT CHARACTER SET utf8 ;
-- -----------------------------------------------------
-- Schema ConLink_db_v03
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `ConLink_db_v03`.`a_aerzte`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConLink_db_v03`.`a_aerzte` (
  `a_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `ConLink_db_v03`.`p_patienten`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConLink_db_v03`.`p_patienten` (
  `p_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_p_patienten_a_aerzte`
    ...
    REFERENCES `ConLink_db_v03`.`a_aerzte` (`a_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ConLink_db_v03`.`t_termine`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConLink_db_v03`.`t_termine` (
  `t_id` INT NOT NULL,
  `t_datum` DATE NULL,
  `t_uhrzeit` TIME NULL,
  ...
  CONSTRAINT `fk_t_termine_p_patienten1`
    FOREIGN KEY (`t_p_id`)
    REFERENCES `ConLink_db_v03`.`p_patienten` (`p_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `ConLink_db_v03`.`b_bewertungen`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConLink_db_v03`.`b_bewertungen` (
  `b_id` INT NOT NULL,
  `b_punkte` INT NULL,
...
-- -----------------------------------------------------
-- Table `ConLink_db_v03`.`tt_termintyp`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConLink_db_v03`.`tt_termintyp` (
  `tt_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `ConLink_db_v03`.`m_medikamente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConLink_db_v03`.`m_medikamente` (
  `m_id` INT NOT NULL,
  `m_name` VARCHAR(45) NULL,
  `m_aktuell` TINYINT NULL,
  PRIMARY KEY (`m_id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ConLink_db_v03`.`l_logging`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConLink_db_v03`.`l_logging` (
...
-- -----------------------------------------------------
-- Table `ConLink_db_v03`.`z_zeitslots`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConLink_db_v03`.`z_zeitslots` (
...
CREATE TABLE IF NOT EXISTS `ConLink_db_v03`.`t_termine` (
  ...
  CONSTRAINT `fk_t_termine_tt_termintyp1`
    FOREIGN KEY (`t_tt_id`)
    REFERENCES `ConLink_db_v03`.`tt_termintyp` (`tt_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_t_termine_z_zeitslots1`
    FOREIGN KEY (`t_z_id`)
    REFERENCES `ConLink_db_v03`.`z_zeitslots` (`z_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `ConLink_db_v03`.`u_userverwaltung`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConLink_db_v03`.`u_userverwaltung` (
...
-- -----------------------------------------------------
-- Table `ConLink_db_v03`.`pm_p_hat_m`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConLink_db_v03`.`pm_p_hat_m` (
  ...
  CONSTRAINT `fk_p_patienten_has_m_medikamente_m_medikamente1`
    FOREIGN KEY (`pm_m_id`)
    REFERENCES `ConLink_db_v03`.`m_medikamente` (`m_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- foreign jey hinzufügen zu t_termine 
ALTER TABLE `ConLink_db_v03`.`t_termine`
...
ALTER TABLE `ConLink_db_v03`.`b_bewertungen`
ADD FOREIGN KEY (`p_a_id`)
REFERENCES `ConLink_db_v03`.`a_aerzte` (`a_id`)
ON DELETE NO ACTION
ON UPDATE NO ACTION;

ALTER TABLE `ConLink_db_v03`.`b_bewertungen`
ADD FOREIGN KEY (`p_patienten_p_id`)
REFERENCES `ConLink_db_v03`.`p_patienten` (`p_id`)
ON DELETE NO ACTION
ON UPDATE NO ACTION;

-- foreign key hinzufügen zu u_userverwaltung 
ALTER TABLE `ConLink_db_v03`.`u_userverwaltung`
...
ALTER TABLE `ConLink_db_v03`.`l_logging`
